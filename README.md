...
4. Name the Lambda Function "Diabetes-Helper-Example-Skill".
...
2. Set "DiabetesHelper" as the skill name and "diabetesHelper" as the invocation name, this is what is used to activate your skill. For example you would say: "Alexa, Ask diabetes help how to make a door."
